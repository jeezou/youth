...
class Bvi {
    ...
    const activeAll = () => {
      ...
      getObject(this._config, (key) => {
        ...
        if (key === 'images') {
          ...
          document
            .querySelector(`.bvi-images-${value}`)
        ...
        if (key === 'speech') {
          ...
          document
            .querySelector(`.bvi-speech-${value}`)
            .classList.add('active');
        }
        ...
        if (key === 'lineHeight') {
          ...
          document
            .querySelector(`.bvi-line-height-${value}`)
            .classList.add('active');
        }
        ...
        if (key === 'letterSpacing') {
          ...
          document
            .querySelector(`.bvi-letter-spacing-${value}`)
            .classList.add('active');
        }
        ...
        if (key === 'fontFamily') {
          ...
          document
            .querySelector(`.bvi-font-family-${value}`)
            .classList.add('active');
        }
        ...
        if (key === 'builtElements') {
          ...
          document
            .querySelector(`.bvi-built-elements-${value}`)
            .classList.add('active');
        }
      });
    };
  ...
  _getPanel() {
    ...
    let panelHide = stringToBoolean(getCookie('panelHide'))
      ? ' bvi-panel-hide'
      : '';
    let linkHide = !stringToBoolean(getCookie('panelHide'))
      ? ' bvi-hide'
      : 'bvi-show';
    let html = `
            ...
            <div class="bvi-modal-dialog">
                <div class="bvi-modal-content">
                    <div class="bvi-modal-header">
                        <div class="bvi-modal-title">${this._i18n.t(
                          'settings'
                        )}</div>
                    ...
                    <div class="bvi-modal-body">
                        <div class="bvi-blocks bvi-block-center">
                            <div class="bvi-block">
                                <div class="bvi-block-title">${this._i18n.t(
                                  'letterSpacing'
                                )}</div>
                                <a href="#" class="bvi-link bvi-letter-spacing-normal">${this._i18n.t(
                                  'normal'
                                )}</a>
                                <a href="#" class="bvi-link bvi-letter-spacing-average">${this._i18n.t(
                                  'average'
                                )}</a>
                                <a href="#" class="bvi-link bvi-letter-spacing-big">${this._i18n.t(
                                  'big'
                                )}</a>
                            </div>
                            <div class="bvi-block">
                                ...
                                <a href="#" class="bvi-link bvi-line-height-normal">${this._i18n.t(
                                  'normal'
                                )}</a>
                                <a href="#" class="bvi-link bvi-line-height-average">${this._i18n.t(
                                  'average'
                                )}</a>
                                <a href="#" class="bvi-link bvi-line-height-big">${this._i18n.t(
                                  'big'
                                )}</a>
                            </div>
                            <div class="bvi-block">
                                ...
                                <a href="#" class="bvi-link bvi-font-family-arial">${this._i18n.t(
                                  'arial'
                                )}</a>
                                <a href="#" class="bvi-link bvi-font-family-times">${this._i18n.t(
                                  'times'
                                )}</a>
                            </div>
                            <div class="bvi-block">
                                ...
                                <a href="#" class="bvi-link bvi-built-elements-on">${this._i18n.t(
                                  'on'
                                )}</a>
                                <a href="#" class="bvi-link bvi-built-elements-off">${this._i18n.t(
                                  'off'
                                )}</a>
                            </div>
                        </div>
                    ...
                    <div class="bvi-modal-footer">
                        <a href="#" class="bvi-link bvi-reset">${this._i18n.t(
                          'reset'
                        )}</a>
                    </div>
                </div>
    ...
    let link =
      `<a href="#" class="bvi-link bvi-link-fixed-top bvi-no-styles ${linkHide}" data-bvi="panel-show">` +
