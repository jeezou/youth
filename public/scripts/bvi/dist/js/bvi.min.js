...
!(function (e, t) {
  ...
  !(function (e) {
    var t = (function (e) {
          ...
          (r._invoke = (function (e, t, n) {
            ...
            return function (o, r) {
              ...
              for (n.method = o, n.arg = r; ; ) {
                ...
                'throw' === l.type &&
                  ((i = d), (n.method = 'throw'), (n.arg = l.arg));
              }
            };
          })(e, n, a)),
          r
      ...
      var k = (p.prototype = b.prototype = Object.create(y));
      function w(e) {
      ...
      function L(e, t) {
        function n(o, r, a, c) {
          ...
          if ('throw' !== l.type) {
            var s = l.arg,
              v = s.value;
            return v && 'object' == typeof v && i.call(v, '__await')
      ...
      return (
        ...
        l(k, 'constructor', p),
        l(p, 'constructor', g),
        (g.displayName = l(p, c, 'GeneratorFunction')),
        ...
        (A.prototype = {
          ...
          delegateYield: function (e, n, i) {
            return (
              (this.delegate = { iterator: q(e), resultName: n, nextLoc: i }),
    ...
    d = function () {
      ...
      (i += 864e5),
        ...
        (document.cookie = 'bvi_'
          ...
          .concat(
            'localhost' !== location.hostname ? location.host : 'localhost'
          ));
    },
    m = function () {
      var e =
            ...
            value: function () {
              ...
              if ('speechSynthesis' in window && l(m('speech'))) {
                if (i) {
                  ...
                  var o = document.querySelectorAll('.bvi-speech-play'),
                    r = document.querySelectorAll('.bvi-speech-pause'),
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if ('speechSynthesis' in window && l(m('speech'))) {
                ...
                c.forEach(function (e) {
                  var r = new SpeechSynthesisUtterance(e.trim());
                  (r.volume = 1),
                    (r.rate = 1),
                    (r.pitch = 1),
                    (r.lang = n._config.lang);
                  for (var a = 0; a < u.length; a++)
                    'ru-RU' === n._config.lang &&
                      ...
                      'en-US' === n._config.lang &&
                        ...
                        (r.voice = u[a]);
                  i &&
                    ((r.onboundary = function (e) {
                      t.classList.add('bvi-highlighting');
                      var n = o(e.utterance.text, e.charIndex),
                        i = t.textContent,
                        r = n.replace(/(\s+)/, '((<[^>]+>)*$1(<[^>]+>)*)'),
                        a = new RegExp('(' + r + ')', 'gi');
